...
alias hyprpush='hyprarch2 push --set-upstream git@github.com:g5ostXa/hyprarch2.git master && hyprarch2 push --set-upstream git@gitlab.com:r3dvx/hyprarch2.git master'
...
alias update-pkg-lists='~/src/Scripts/update_pkgs_lists.sh'
end
